...
\lstinputlisting[language=C++]{code/binary_search.cpp}
...
\lstinputlisting[language=C++]{code/geometry_cpp/geometry.cpp}

\subsection*{Check if point is on a line segment}
\lstinputlisting[language=python]{code/geometry_py/on_segment.py}
\lstinputlisting[language=C++]{code/geometry_cpp/on_segment.cpp}
...
\begin{multicols}{2}
  \lstinputlisting[language=C++]{code/geometry_cpp/dist_ps.cpp}
  \columnbreak
...
\begin{multicols}{2}
  \lstinputlisting[language=C++]{code/geometry_cpp/dist_pl.cpp}
  \columnbreak
...
\begin{multicols}{2}
  \lstinputlisting[language=C++]{code/geometry_cpp/proj_pl.cpp}
  \columnbreak
...
\begin{multicols}{2}
  \lstinputlisting[language=C++]{code/geometry_cpp/intersect_ll.cpp}
  \columnbreak
...
\begin{multicols}{2}
  \lstinputlisting[language=C++]{code/geometry_cpp/intersect_ss.cpp}
  \columnbreak
...
\begin{multicols}{2}
  \lstinputlisting[language=C++]{code/geometry_cpp/polygon_area.cpp}
  \columnbreak
...
\lstinputlisting[language=C++]{code/geometry_cpp/point_in_polygon.cpp}
...
\begin{multicols}{2}
  \lstinputlisting[language=C++]{code/geometry_cpp/intersect_cc.cpp}
  \columnbreak
...
\begin{multicols}{2}
  \lstinputlisting[language=C++]{code/geometry_cpp/intersect_cl.cpp}
  \columnbreak
...
\begin{multicols}{2}
  \lstinputlisting[language=C++]{code/geometry_cpp/circumcircle.cpp}
  \columnbreak
...
\lstinputlisting[language=C++]{code/geometry_cpp/circle_poly_area.cpp}
...
\begin{multicols}{2}
  \lstinputlisting[language=C++]{code/geometry_cpp/circle_tangents.cpp}
  \columnbreak
...
\begin{multicols}{2}
  \lstinputlisting[language=C++]{code/geometry_cpp/convex_hull.cpp}
  \columnbreak
...
\lstinputlisting[language=C++]{code/link_cut_tree.cpp}
...
\lstinputlisting[language=C++]{code/weighted_matching.cpp}
...
\lstinputlisting[language=C++]{code/modmul.cpp}
...
\begin{multicols}{2}
  \lstinputlisting[language=C++]{code/is_prime.cpp}
  \columnbreak
...
\begin{multicols}{2}
  \lstinputlisting[language=C++]{code/prime_factorize.cpp}
  \columnbreak
...
\lstinputlisting[language=C++]{code/fraction_binary_search.cpp}
...
\lstinputlisting[language=C++]{code/matrix_invert.cpp}
...
\lstinputlisting[language=C++]{code/fft_mod.cpp}
